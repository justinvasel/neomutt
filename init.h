...
struct Option MuttVars[] = {
  ...
  */
  ...
  { "edit_hdrs",              DT_SYNONYM, R_NONE, 0, UL "edit_headers",             },
  { "envelope_from",          DT_SYNONYM, R_NONE, 0, UL "use_envelope_from",        },
  { "forw_decode",            DT_SYNONYM, R_NONE, 0, UL "forward_decode",           },
  { "forw_decrypt",           DT_SYNONYM, R_NONE, 0, UL "forward_decrypt",          },
  { "forw_format",            DT_SYNONYM, R_NONE, 0, UL "forward_format",           },
  { "forw_quote",             DT_SYNONYM, R_NONE, 0, UL "forward_quote",            },
  { "hdr_format",             DT_SYNONYM, R_NONE, 0, UL "index_format",             },
  { "indent_str",             DT_SYNONYM, R_NONE, 0, UL "indent_string",            },
  { "mime_fwd",               DT_SYNONYM, R_NONE, 0, UL "mime_forward",             },
  { "msg_format",             DT_SYNONYM, R_NONE, 0, UL "message_format",           },
  { "pgp_autoencrypt",        DT_SYNONYM, R_NONE, 0, UL "crypt_autoencrypt",        },
  { "pgp_autosign",           DT_SYNONYM, R_NONE, 0, UL "crypt_autosign",           },
  { "pgp_auto_traditional",   DT_SYNONYM, R_NONE, 0, UL "pgp_replyinline",          },
  { "pgp_create_traditional", DT_SYNONYM, R_NONE, 0, UL "pgp_autoinline",           },
  { "pgp_replyencrypt",       DT_SYNONYM, R_NONE, 0, UL "crypt_replyencrypt",       },
  { "pgp_replysign",          DT_SYNONYM, R_NONE, 0, UL "crypt_replysign",          },
  { "pgp_replysignencrypted", DT_SYNONYM, R_NONE, 0, UL "crypt_replysignencrypted", },
  { "pgp_verify_sig",         DT_SYNONYM, R_NONE, 0, UL "crypt_verify_sig",         },
  { "post_indent_str",        DT_SYNONYM, R_NONE, 0, UL "post_indent_string",       },
  { "print_cmd",              DT_SYNONYM, R_NONE, 0, UL "print_command",            },
  { "smime_sign_as",          DT_SYNONYM, R_NONE, 0, UL "smime_default_key",        },
  { "xterm_icon",             DT_SYNONYM, R_NONE, 0, UL "ts_icon_format",           },
  { "xterm_set_titles",       DT_SYNONYM, R_NONE, 0, UL "ts_enabled",               },
  { "xterm_title",            DT_SYNONYM, R_NONE, 0, UL "ts_status_format",         },
